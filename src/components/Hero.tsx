  ...
  return <section className={cn('relative min-h-[90vh] overflow-hidden', className)}>
      <LampContainer className="w-full min-h-[85vh]">
        ...
        ease: "easeInOut"
          ...
          <motion.h1 className="text-4xl md:text-6xl font-bold mb-4 tracking-tight bg-gradient-to-br from-white to-slate-400 bg-clip-text text-transparent" initial={{
          opacity: 0.5,
          y: 100
        }} whileInView={{
          opacity: 1,
