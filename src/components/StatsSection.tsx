...
import { Award, Users, BarChart3, Target, Code, Rocket, Globe } from 'lucide-react';
...
const StatsSection = ({ className }: StatsSectionProps) => {
  ...
  useEffect(() => {
    ...
    const incrementExperience = Math.ceil(stats.experience / steps);
    ...
    const timer = setInterval(() => {
      setCounts(prev => {
        const newExperience = Math.min(prev.experience + incrementExperience, stats.experience);
        ...
        const isComplete = 
          newExperience === stats.experience && 
      ...
      <div className="container mx-auto px-4">
        <div className="text-center mb-12">
          ...
          <p className="text-slate-300 max-w-2xl mx-auto">
            Vibelaunch has helped thousands of founders achieve their launch goals and build successful products
          </p>
        </div>

        <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-6 max-w-5xl mx-auto">
          <motion.div 
            className="frost-container p-6 text-center backdrop-blur-sm hover:border-neon/50 hover:shadow-neon-sm transition-all duration-300"
          ...
          >
            ...
            <h3 className="text-4xl font-bold text-neon mb-2">{counts.experience}+</h3>
